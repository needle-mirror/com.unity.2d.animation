...
namespace UnityEditor.U2D.Animation
{
    internal static class TextContent
    {
        ...
        public static string hoveredOutlineColor = L10n.Tr("Hovered Outline Color");
        ...
        // Bone overlay (Scene View)
        public static string boneOverlayName = L10n.Tr("Bone");
        public static string boneOverlayColorLabel = L10n.Tr("Color");
    }
}

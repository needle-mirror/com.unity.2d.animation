...
3. In the Scene, select the [Instantiated Prefab](https://docs.unity3d.com/6000.4/Documentation/Manual/instantiating-prefabs.html) and then select the `Scarf` GameObject in the Hierarchy window.

...
In a single [Animator Controller](https://docs.unity3d.com/6000.3/Documentation/Manual/class-AnimatorController.html), you can't have one [Animation Clip](https://docs.unity3d.com/6000.3/Documentation/Manual/AnimationClips.html) animating the [Sprite Renderer’s](https://docs.unity3d.com/6000.3/Documentation/Manual/class-SpriteRenderer.html) assigned sprite while another [Animation Clip](https://docs.unity3d.com/6000.3/Documentation/Manual/AnimationClips.html) animates the [Sprite Resolver’s](SL-Resolver.md) sprite hash. If these two clips are in the same [Animator Controller](https://docs.unity3d.com/6000.3/Documentation/Manual/class-AnimatorController.html), they will conflict with each other and cause unwanted playback results.

Use the following recommended methods to resolve this issue.

1. The first method is to separate the [Animation Clips](https://docs.unity3d.com/6000.3/Documentation/Manual/AnimationClips.html) into separate [Animator Controllers](https://docs.unity3d.com/6000.3/Documentation/Manual/class-AnimatorController.html) that contain only clips that animate either a [Sprite Renderer’s](https://docs.unity3d.com/6000.3/Documentation/Manual/class-SpriteRenderer.html) sprite or the [Sprite Resolver’s](SL-Resolver.md) sprite hash but not both types in the same [Animator Controller](https://docs.unity3d.com/6000.3/Documentation/Manual/class-AnimatorController.html).
   <br/>

2. The second method is to update all [Animation Clips](https://docs.unity3d.com/6000.3/Documentation/Manual/AnimationClips.html) to the same type so that they can all remain in a single [Animator Controller](https://docs.unity3d.com/6000.3/Documentation/Manual/class-AnimatorController.html). To do so, convert all clips animating a [Sprite Renderer’s](https://docs.unity3d.com/6000.3/Documentation/Manual/class-SpriteRenderer.html) sprite to animating a [Sprite Resolver’s](SL-Resolver.md) sprite hash, or vice versa.

## Additional resources
- [Animation](https://docs.unity3d.com/6000.3/Documentation/Manual/AnimationSection.html)
- [Skinning Editor](SkinningEditor.md)
- [PSD Importer package](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@12.0)

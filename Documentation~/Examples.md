...
2D Animation Samples are distributed with the 2D Animation package and can be imported via the Package Manager. The samples consist of multiple examples on how certain outcomes can be achieved. The samples will be installed to *Assets/Samples/2D Animation/[X.Y.Z]/Samples* where [X.Y.Z] is the package version where the samples are installed from.

The following samples are available:

- [Simple](#simple)
- [Single skinned Sprite](#single-skinned-sprite)
- [Multiple skinned Sprite](#multiple-skinned-sprite)
- [Rigging a character imported with the PSD Importer](#CharacterRig)
...
## Rigging a character imported with the PSD Importer <a name="CharacterRig"></a>

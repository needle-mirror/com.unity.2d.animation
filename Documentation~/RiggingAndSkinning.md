...
Prepare your actor for animation with the Skinning Editor after you have [imported](PreparingArtwork.md) it into Unity.

| Topic | Description |
|-|-|
| [Actor rigging and weighting workflow](CharacterRig.md) | Create bones, generate meshes, and adjust the weights for your actor. |
| [Rig and weight an actor in the Skinning Editor](SkinningEditor.md) | Open the Skinning Editor and select sprites, bones, and meshes. |
